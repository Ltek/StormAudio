"""StormAudio media players."""

from __future__ import annotations

from decimal import Decimal

from .stormaudio_telnet.constants import PowerCommand, ProcessorState
...
async def async_setup_entry(
    ...
    sa_device: StormAudioDevice = StormAudioDevice(coordinator)
    add_entities([sa_device])

    coordinator.data["device"] = sa_device


class StormAudioDevice(CoordinatorEntity, MediaPlayerEntity):
    """StormAudio device."""
    ...
    def __init__(self, coordinator: StormAudioCoordinator) -> None:
        """Initialize."""
